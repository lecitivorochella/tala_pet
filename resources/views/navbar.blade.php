  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active text-dark fw-bold" href="{{ route('petui') }}">Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark fw-bold" href="#">Our Pets</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark fw-bold" href="#">Why Adopt</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark fw-bold" href="#">FAQs</a>
        </li>
      </ul>
